  ...
  return (
    <div className="parallax-container">
      ...
      <div className="parallax-layer parallax-bg">
        {/* Background Blobs */}
        <div className="blob bg-cyan-300" style={{ width: "600px", height: "600px", top: "10%", left: "-200px" }}></div>
        <div className="blob bg-teal-300" style={{ width: "500px", height: "500px", top: "40%", right: "-150px" }}></div>
        <div className="blob bg-cyan-200" style={{ width: "400px", height: "400px", top: "70%", left: "10%" }}></div>
        <div className="blob bg-teal-200" style={{ width: "450px", height: "450px", top: "90%", right: "20%" }}></div>
      </div>
