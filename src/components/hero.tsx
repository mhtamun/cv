    ...
    <section className="min-h-screen flex items-center justify-center pt-20 pb-10 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="order-2 md:order-1">
          ...
          <p className="text-gray-600 mb-8 animate-fade-in delay-300">
            {data.description}
          </p>
          <div className="flex flex-wrap gap-4 animate-fade-in delay-400">
            ...
            >
              <i className={`fas ${data.ctaButtons.primary.icon} mr-2`}></i> {data.ctaButtons.primary.text}
            </Link>
            <Link
            ...
            >
              <i className={`fas ${data.ctaButtons.secondary.icon} mr-2`}></i> {data.ctaButtons.secondary.text}
            </Link>
          </div>
        </div>
        <div className="order-1 md:order-2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80 animate-float">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-40 h-40 md:w-48 md:h-48 rounded-full bg-white shadow-xl flex items-center justify-center animate-scale-up">
                <i className="fas fa-user text-6xl text-cyan-600"></i>
              </div>
            </div>
          </div>
        </div>
